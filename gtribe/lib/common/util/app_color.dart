...
Color buttonColor = const Color.fromRGBO(71, 83, 102, 1);
Color defaultAvatarColor = const Color.fromRGBO(101, 85, 193, 1);
Color buttonBackgroundColor = const Color.fromRGBO(1, 13, 15, 1);
...
Color modalBackground = const Color(0xff30242B);
List<Color> primaryButtonGradient = [
  const Color(0xffE09422),
  const Color(0xffDA13AE)
];
